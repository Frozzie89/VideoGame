...
// Méthode dont le but sera de récupérer une ability via la méthode "getRandomAbility"
// Pour ensuite activer l'effet de cette ability dépendant de si elle est offensive ou défensive
...
// Permet de récupérer une ability de manière aléatoire
// On dépend ici de m_rate qui correspond au % de chance de récuperer une ability défensive
...
// Recherche une ability d'un type précis dans la liste et retourne son indice
